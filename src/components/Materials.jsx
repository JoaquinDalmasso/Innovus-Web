    ...
    <section className="w-full bg-lime-950 py-12 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="space-y-4 text-center">
            <h2 className="text-3xl text-black font-bold tracking-tighter sm:text-4xl">Materiales</h2>
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-2 gap-6 py-12 sm:grid-cols-3 lg:grid-cols-4">
            <div className="flex flex-col items-center gap-2">
              ...
              <h3 className="text-lg text-black font-medium">ABS</h3>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <h3 className="text-lg text-black font-medium">PLA</h3>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <h3 className="text-lg text-black font-medium">PETG</h3>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <h3 className="text-lg text-black font-medium">Nylon</h3>
